...
class RemoteCondorPluginTest(BossAirTest):
    """
    _CondorPluginTest_
    ...
    def tes2t2C_CondorTest(self):
        ...
        """
        nRunning = 0 #getCondorRunningJobs(self.user)
    ...
    @attr('integration')
    def tes2tD_PrototypeChain(self):
        """
        _PrototypeChain_
    ...
    def testF_WMSMode(self):
        ...
        config = self.getConfig()
        #config.BossAir.pluginName = 'RemoteCondorPriorityPlugin'
